...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    editLinks: true, // 启用编辑
    editLinkText: '编辑',
    bodyBgImg: '/img/bg1.jpg' ,  // 你的图片路径(必须位于 public 下)，可以是 URL
    ...
    indexImg: {
      ...
      desc: ["随风而至", "无悔而行", "默默前行"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFadeIn 为 true 生效
    ...
    author: {
      name: 'zfprotectors', // 必需
      link: 'https://github.com/protectors', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'zfprotectors | <a href="https://beian.miit.gov.cn/" target="_blank">闽ICP备2021014222号</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
